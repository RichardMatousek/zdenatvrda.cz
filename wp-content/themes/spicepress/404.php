		...
		<div class="row">
			<div class="col-md-12">
				<div class="error_404 wow flipInX animated" data-wow-delay=".5s">
					...
					<p><?php esc_attr_e("We are sorry, but the page you are looking for does not exist.","spicepress"); ?> 
					<p><a href="<?php echo esc_html(site_url());?>" class="error_404_btn"><i class="fa fa-arrow-circle-left"></i><?php _e('Go Back','spicepress'); ?></a></p>
				</div>
			</div>
		</div>
	</div>
