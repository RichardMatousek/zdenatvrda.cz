...
<div id="getting_started" class="spicepress-tab-pane active">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<h1 class="spicepress-info-title text-center"><?php echo __('About the SpicePress theme','spicepress'); ?><?php if( !empty($spicepress['Version']) ): ?> <sup id="spicepress-theme-version"><?php echo esc_attr( $spicepress['Version'] ); ?> </sup><?php endif; ?></h1>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6">
			...
			<div class="col-md-6">
				<div class="spicepress-tab-pane-half spicepress-tab-pane-first-half">
				<img src="<?php echo esc_url( get_template_directory_uri() ) . '/functions/spicepress-info/img/spicepress.png'; ?>" alt="<?php esc_html_e( 'SpicePress theme', 'spicepress' ); ?>" />
				</div>
			</div>	
		</div>
		...
		<div class="row">
			...
			<div class="col-md-6"> 
				<div class="spicepress-tab-pane-half spicepress-tab-pane-first-half">
					...
					<p class="info-text"><?php echo __('Lite Demo','spicepress'); ?></p></a>
					...
					<p class="info-text"><?php echo __('PRO Demo','spicepress'); ?></p></a>
			...
			<div class="col-md-6">	
				...
				<div class="spicepress-tab-pane-half spicepress-tab-pane-first-half">
					...
					<p class="info-text"><?php echo __('Your feedback is valuable to us','spicepress'); ?></p></a>
					...
					<p class="info-text"><?php echo __('Premium Theme Support','spicepress'); ?></p></a>
				</div>
			</div>
			...
			<div class="col-md-6">	
				...
				<div class="spicepress-tab-pane-half spicepress-tab-pane-first-half">
					...
					<p class="info-text"><?php echo __('Premium Theme Details','spicepress'); ?></p></a>
