...
class Spicepress_Customizer_Notify {
	...
	public function spicepress_customizer_notify_scripts_for_customizer() {
		...
		wp_enqueue_style( 'spicepress-customizer-notify-css', get_template_directory_uri() . '/functions/customizer-notify/css/spicepress-customizer-notify.css', array());
		...
		wp_enqueue_script( 'spicepress-customizer-notify-js', get_template_directory_uri() . '/functions/customizer-notify/js/spicepress-customizer-notify.js', array( 'customize-controls' ));
		wp_localize_script(
			'spicepress-customizer-notify-js', 'spicepressCustomizercompanionObject', array(
				'ajaxurl'            => admin_url( 'admin-ajax.php' ),
				'template_directory' => get_template_directory_uri(),
				'base_path'          => admin_url(),
				'activating_string'  => __( 'Activating', 'spicepress' ),
			)
		);
	...
	public function spicepress_plugin_notification_customize_register( $wp_customize ) {
		...
		require_once get_template_directory() . '/functions/customizer-notify/spicepress-customizer-notify-section.php';
