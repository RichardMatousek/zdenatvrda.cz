...
class WP_Pro_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
     <div class="pro-box">
       <a href="<?php echo esc_url('https://spicethemes.com/spicepress/');?>" target="_blank" class="upgrade-spicepress-pro" id="review_pro"><?php _e( 'UPGRADE TO PRO','spicepress' ); ?></a>
...
$wp_customize->add_section( 'spicepress_pro_section' , array(
		'title'      => __('Upgrade to Pro','spicepress'),
		'priority'   => 1000,
   	) );
